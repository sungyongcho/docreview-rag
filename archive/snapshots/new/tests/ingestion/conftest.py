...
레퍼런스와 자기 구현을 바꿔 가며 돌릴 수 있다:
    uv run pytest tests/ingestion                                         # app.ingestion.parser
    PARSER_MODULE=app.ingestion.parser_mine uv run pytest tests/ingestion # 내가 짜는 것
"""
