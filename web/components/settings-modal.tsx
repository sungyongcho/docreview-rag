...
import { DEFAULT_EXPERIMENT_DEFAULTS, DEFAULT_PROFILE, DEFAULT_SESSION_PROFILE } from "@/lib/types";
...
type Category = "review" | "prompt" | "limits" | "experiments" | "runtime" | "data" | "snapshot";
...
export function SettingsModal(props: Props) {
  ...
  function locked() { notify("Production experiment controls are locked. Prompt, retrieval, and evaluation experiments are available in Dev to prevent unbounded provider and indexing costs.", "warning", "prod-locked"); }
