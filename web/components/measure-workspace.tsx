    ...
    <section className="lab-shell measure-workspace">
      ...
      {tab === "runs" && (live ? <div className="two-column run-workspace">
        <section className="surface form-stack">
          ...
          <details><summary>Retrieval profile · {profileSummary(profile)}</summary><ProfileFields profile={profile} onChange={onProfileChange} /></details>
        ...
        <div className="panel-stack run-results">
          <section className="surface">
            <div className="surface-heading"><h2>Results</h2><button className="button primary" type="button" disabled={selectedResultId === null} onClick={applySelectedResult}>Use selected set</button></div>
      ...
      {tab === "compare" && <div className="panel-stack">
        {comparison ? <>
