...
import { DEVELOPMENT_STORY_SOURCE, DOCUMENTATION_REGISTRY, documentationDocuments } from "../lib/documentation-registry.mjs";
...
export async function writeTutorialFixtures(root, registry = DOCUMENTATION_REGISTRY) {
  await writeFile(join(root, DEVELOPMENT_STORY_SOURCE), "# 개발 기록 초안\n\n## References\n\n[Reference](https://example.com/reference)");
