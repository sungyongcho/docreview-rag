...
const MEASURE_TABS: Record<MeasureTab, string> = { playground: "Search trial", golden: "Golden dataset", runs: "Run evaluation", compare: "Compare and save", snapshots: "Snapshots", defaults: "Defaults" };
