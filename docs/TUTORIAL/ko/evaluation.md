...
**평가 설정 체험**에서 Quick/Matrix, 청크 크기와 검색 파라미터를 브라우저 안에서 변경합니다. 요청 미리보기는 전송되지 않습니다. 체험 설정 저장은 브라우저에만 적용하며 기록된 점수는 바뀌지 않습니다. 평가 실행·데이터셋 편집·스냅샷 생성은 DEV 배지를 유지하고 잠급니다.
