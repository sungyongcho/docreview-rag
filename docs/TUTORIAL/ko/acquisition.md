...
스키마 불일치로 인덱싱이 막혀 있어도 원문 저장과 작업 기록 저장이 가능하면 수집은 진행할 수 있습니다. 스키마 문제에 HOST_GID를 바꾸지 말고 별도의 진단을 확인하세요. 수집 완료 후 반환된 manifest/selection 쌍을 선택해 인제스트합니다.
