...
**화면 경로:** **품질 검증 → 4. 결과 비교·보관 → 결과 비교**에서 비교합니다. 이후 **3. 평가 실행**으로 돌아가 적합한 결과를 선택하고 **결과 상세**를 엽니다.
...
**보이는 변화:** 스냅샷 생성 알림이 나옵니다. **4. 결과 비교·보관 → 저장 스냅샷**에서 이름·문서 수·suite·결과 ID를 확인합니다. 처음에는 비공개이며 저장만으로 게시되지 않습니다.
