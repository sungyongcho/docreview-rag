...
|---|---|---|---|
| `budget_exceeded` | `resource`, `limit`, `observed`, `blocked_node` | Adjust the specific cumulative limit under RAG settings → Run limits when appropriate. | A deliberate new run stays within the intended limit. |
