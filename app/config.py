"""Environment-driven settings shared across ingestion and retrieval."""
...
class Settings(BaseSettings):
    ...
    bm25_k1: float = Field(default=DEFAULT_BM25_K1, gt=0)
    bm25_b: float = Field(default=DEFAULT_BM25_B, ge=0, le=1)
