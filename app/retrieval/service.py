...
async def retrieve(
    ...
    *,
    ...
    route_by_language : bool | None, optional
        Whether Korean queries skip the English lexical component. ``None`` reads
        the setting from ``Settings.query_language_routing``.
