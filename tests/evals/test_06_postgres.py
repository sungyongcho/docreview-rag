"""Optional loopback PostgreSQL proof for the isolated M3 evaluation path."""
...
from app.evals.ablation import RetrievalStrategy
...
def _batch() -> SeedBatch:
    document = DocumentRecord(
        ...
        url="https://example.test/nvda-2024",
        parse_status="parsed",
...
def test_live_postgres_runs_isolated_matrix_and_regression_persistence():
    ...
    reachable, detail = asyncio.run(_exercise(database_url.set(host="127.0.0.1")))
    if not reachable:
